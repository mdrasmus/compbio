...
fungi2 = """(((((((scer:7.061760[&&NHX:a=b],spar:7.061760):4.999680,smik:12.061440):5.970600,sbay:18.032040):52.682400,cgla:70.714260):7.220700,scas:77.934960):23.181480,((agos:78.553260,klac:78.553260):10.434960,kwal:88.988220):12.128400):78.883560,(((calb:41.275620,ctro:41.275980):29.632860,(cpar:52.323120,lelo:52.323120):18.585720):31.149540,((cgui:75.615840,dhan:75.615840):14.006880,clus:89.622720):12.435660)xx:77.941620);"""
...
'''
    ...
    def test_reorder(self):
        ...
        self.assert_(hashtree1 != hashtree2)
    ...
    def test_nhx(self):
        ...
        data = {'ADH3': {'S': 'yeast', 'E': '1.1.1.1'}, 1: {'E': '1.1.1.1', 'D': 'N'}, 2: {'S': 'Metazoa', 'E': '1.1.1.1', 'D': 'N'}, 3: {'S': 'Primates', 'B': '100', 'E': '1.1.1.1', 'D': 'Y'}, 4: {'S': 'Fungi'}, 'ADH2': {'S': 'human', 'E': '1.1.1.1'}, 'ADHY': {'S': 'nematode', 'E': '1.1.1.1'}, 'ADHX': {'S': 'insect', 'E': '1.1.1.1'}, 'ADH1': {'S': 'human', 'E': '1.1.1.1'}, 'ADH1_1': {'S': 'yeast', 'E': '1.1.1.1'}, 'ADH4': {'S': 'yeast', 'E': '1.1.1.1'}, 'ADH2_1': {'S': 'yeast', 'E': '1.1.1.1'}}
